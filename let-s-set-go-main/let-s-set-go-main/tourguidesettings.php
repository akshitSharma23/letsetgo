...
if($np==$cnp)
{
 $result= mysqli_query($con,"select * from tourguide where email='$email'") or die(mysqli_error());
 $row= mysqli_fetch_array($result);

 if($row['password']==$password)
 {
	 mysqli_query($con,"update tourguide set password='$np' where password='$password'") or die(mysqli_error());
